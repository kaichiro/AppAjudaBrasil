package fukuda.com.appajudabrasil
...
class ProposicoesAdapter (
    val list: List<Proposicao>, val context: Context, val requestQueue: RequestQueue
) : RecyclerView.Adapter<ProposicoesAdapter.ViewHolder>() {
